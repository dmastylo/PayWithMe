module EventUsersHelper
  def event_user_pay_button(event_user, payment_method)
    ...
    link_to "Pay #{humanized_money_with_symbol event_user.event.split_amount} With #{payment_method}", path, class: "payment-link btn btn-primary btn-block push-bottom"
  end
